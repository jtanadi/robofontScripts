    ...
    def makeDrawing(self):
        ...
        def pageSetup():
            ...
            def _drawAscender(xHeightlist):
                ...
                ascenderTarget = calculateMetrics(self.xHeightTarget)[1]
            ...
            def _drawDescender(baselineList):
                ...
                descenderTarget = calculateMetrics(self.xHeightTarget)[2]
            ...
            def _calculateSketchLines():
                ...
                for i in spacerRange:
                    spacer = i * self.xHeightTarget
                                        
                    xHeightList.append(firstXHeightLine - spacer)
                    baselineList.append(firstXHeightLine - spacer - self.xHeightTarget)
        ...
        def drawLetters():        
            ...
            if hasattr(self, "inputText"):
                ...
                xFactor = calculateMetrics(self.xHeightTarget)[0]
                ...
                translate(marginLBR, firstXHeightLine-self.xHeightTarget)
